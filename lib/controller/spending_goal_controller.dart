...
class SpendingGoalController extends GetxController {
  ...
  TransactionController get transactionController => Get.find<TransactionController>();
  ...
  double calculateProgress(SpendingGoalModel spendingGoal) {
    ...
    return spendingGoal.limitValue > 0 ? spentAmount / spendingGoal.limitValue : 0.0;
  }
