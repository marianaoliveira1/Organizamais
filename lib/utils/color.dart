...
class DefaultColors {
  ...
  static const backgroundCard = Color(0xFF1E1E1E);
  static const backgroundgreyDark = Color(0xFF757575);

  static const textGrey = Color(0xFF5D5C5D);
  ...
  static const brightRed = Color(0xFFEF9A9A);
  static const pink = Color(0xFFF48FB1);
  static const teal = Color(0xFF80CBC4);
  static const darkBlue = Color(0xFF7986CB);
  ...
  static const maroon = Color(0xFF795548);

  // Novas cores vibrantes
  static const vibrantPink = Color(0xFFE91E63);
  static const vibrantPurple = Color(0xFF9C27B0);
  ...
  static const vibrantYellow = Color(0xFFFFEB3B);
  static const vibrantRed = Color(0xFFF44336);
  static const vibrantTeal = Color(0xFF009688);
  static const vibrantCyan = Color(0xFF00BCD4);
  static const vibrantLime = Color(0xFFCDDC39);

  // Novas cores claras/pastéis
  ...
  static const pastelRed = Color(0xFFFFCDD2);
