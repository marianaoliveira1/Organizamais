...
class ResumePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, List<dynamic>> groupTransactionsByDate(List transactions) {
      ...
      grouped.forEach((_, transactions) => transactions.sort((a, b) => DateTime.parse(b.paymentDay!).compareTo(DateTime.parse(a.paymentDay!))));
          ...
          child: SafeArea(
            child: Column(
              children: [
                ...
                Obx(() {
                  if (transactionController.transaction.isEmpty) return const DefaultTextNotTransaction();
